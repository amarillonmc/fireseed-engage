...
if (isset($_POST['recruit_type'])) {
    ...
    if ($canRecruit) {
        ...
        if (isset($cost['bright'])) {
            $resource->reduceBrightCrystal($cost['bright']);
        }
        if (isset($cost['warm'])) {
            $resource->reduceWarmCrystal($cost['warm']);
        }
        if (isset($cost['cold'])) {
            $resource->reduceColdCrystal($cost['cold']);
        }
        if (isset($cost['green'])) {
            $resource->reduceGreenCrystal($cost['green']);
        }
        if (isset($cost['day'])) {
            $resource->reduceDayCrystal($cost['day']);
        }
        if (isset($cost['night'])) {
            $resource->reduceNightCrystal($cost['night']);
        }
        ...
        for ($i = 0; $i < $recruitCount; $i++) {
            ...
            if ($generalId) {
                ...
                // 随机学习一个技能
                $skillInfo = GeneralSkill::getRandomSkill();
                $general->learnSkill($skillInfo['name'], $skillInfo['effect']);
            }
        }
                ...
                <div class="general-card">
                    <h4>
                        ...
                        <span class="rarity <?php echo $recruitedGeneral->getRarity(); ?>">
                            <?php
                            $rarityText = '';
                            switch ($recruitedGeneral->getRarity()) {
                                case 'common':
                                    $rarityText = '普通';
                                    break;
                                case 'uncommon':
                    ...
                    <div class="attributes">
                        <div class="attribute">
                            <div class="name">统帅</div>
                            <div class="value"><?php echo $recruitedGeneral->getLeadership(); ?></div>
                        </div>
                        <div class="attribute">
                            <div class="name">武力</div>
                            <div class="value"><?php echo $recruitedGeneral->getStrength(); ?></div>
                        </div>
                        <div class="attribute">
                        ...
                        <div class="attribute">
                            <div class="name">政治</div>
                            <div class="value"><?php echo $recruitedGeneral->getPolitics(); ?></div>
                        </div>
                        <div class="attribute">
                            <div class="name">魅力</div>
                            <div class="value"><?php echo $recruitedGeneral->getCharm(); ?></div>
                        </div>
                    </div>
