...
CREATE TABLE `resources` (
  ...
  `bright_production_remainder` decimal(20,6) NOT NULL DEFAULT 0,
  `warm_crystal` int(11) NOT NULL DEFAULT 1000,
  `warm_production_remainder` decimal(20,6) NOT NULL DEFAULT 0,
  `cold_crystal` int(11) NOT NULL DEFAULT 1000,
  `cold_production_remainder` decimal(20,6) NOT NULL DEFAULT 0,
  `green_crystal` int(11) NOT NULL DEFAULT 1000,
  `green_production_remainder` decimal(20,6) NOT NULL DEFAULT 0,
  `day_crystal` int(11) NOT NULL DEFAULT 1000,
  `day_production_remainder` decimal(20,6) NOT NULL DEFAULT 0,
  `night_crystal` int(11) NOT NULL DEFAULT 1000,
  `night_production_remainder` decimal(20,6) NOT NULL DEFAULT 0,
