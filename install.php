                ...
                if ($sql) {
                    ...
                    foreach ($statements as $statement) {
                        ...
                        if (!empty($statement)) {
                            ...
                            // SQL层控制命令与触发器DDL不能再套入mysqli预处理协议 / SQL-level controls and trigger DDL cannot be nested inside the mysqli prepared-statement protocol
                            if (isInstallerSqlServerPrepareCommand(
                                $statement
                            )) {
